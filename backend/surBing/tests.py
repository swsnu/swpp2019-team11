...
class SurBingTestCase(TestCase): 
    def setUp(self):
        ...
        res = Response.objects.create(respondant_id = 1, content = 'content' )
    ...
    def test_surveys(self):
        ...
        client.post('/api/signup/', json.dumps({'username':'jomjung', 'password':'1234', 'email':'qwerty@gmail.com'}), content_type='application/json')
        client.post('/api/login/', json.dumps({'username':'jomjung', 'password':'1234'}), content_type='application/json')
        #surveys keyerror
    ...
    def test_cart(self):
        ...
        client.post('/api/login/', json.dumps({'username':'testuser', 'password':'test'}), content_type='application/json')
        #cart test
        ...
        #cart put(delete)
        response = client.put('/api/mycart/', json.dumps({'id_list': [1]}), content_type='application/json')
        self.assertEqual(response.status_code, 200)
    ...
    def test_logout(self):
        ...
        response = client.post('/api/login/', json.dumps({'username':'testuser', 'password':'test'}), content_type='application/json')
        self.assertEqual(response.status_code, 204)
