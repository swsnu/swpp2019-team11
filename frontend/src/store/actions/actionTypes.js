...
export const GET_PARTICIPATED_LIST = 'GET_PARTICIPATED_LIST';

export const ADD_POINT = 'ADD_POINT';
export const GET_PARTICIPATING_LIST = 'GET_PARTICIPATING_LIST';
...
export const GET_MY_ONGOING_SURVEYS = 'GET_MY_ONGOING_SURVEYS';
export const GET_ONGOING_SURVEY = 'GET_ONGOING_SURVEY';
export const ADD_ONGOING_SURVEY = 'ADD_ONGOING_SURVEY';
export const EDIT_SURVEY = 'EDIT_SURVEY';
export const DELETE_ONGOING_SURVEY = 'DELETE_ONGOING_SURVEY';
