...
import { Icon, Grid, Label, Table, Button } from 'semantic-ui-react';
          ...
          <Grid.Row>
            ...
            <Table celled style={{margin: 20, height: 200, width: '450px'}}>
              ...
              <Table.Body style={{'font-size': '0.8em' }}>
                <Table.Row>
                  <Table.Cell>
                    Upload Date : {this.props.survey.upload_date} <br />
                    Survey date : {this.props.survey.survey_start_date}~{this.props.survey.survey_end_date} <br />
                    author : {this.props.survey.author} <br />
                    respondant_count : {this.props.survey.respondant_count} <br />
                    Description : {this.props.survey.content}
                  </Table.Cell>
                </Table.Row>
              </Table.Body>
            </Table>
            ...
            <Grid.Column verticalAlign = 'center' textAlign = 'middle'>
              <Button onClick={() => { this.onClickDownload(); }}>
                <Icon size = 'large' name = 'file outline' /> Download
              </Button>
            </Grid.Column>
          </Grid.Row>
        </Grid>
