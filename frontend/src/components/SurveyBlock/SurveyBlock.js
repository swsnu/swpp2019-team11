  ...
  return(
    <Grid padded>
      <Grid.Row style = {{minWidth: '1000px'}} verticalAlign = 'middle' >
          ...
          {props.search ? (<Button color = 'teal' verticalAlign = 'middle' floated = 'right' size = 'huge' attached = 'right' style = {{width : '50px',height : '99px', 'verticalAlign' : 'middle', 'border-top-right-radius' : '20px', 'border-bottom-right-radius' : '20px', 'padding-top' : '35px'}}><Icon name = 'cart arrow down'/></Button>) : null}
      </Grid.Row>
    </Grid>
  )
}
